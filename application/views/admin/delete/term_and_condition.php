                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?=base_url('admin/term_and_condition')?>"> 
                         ...
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Term And Condition</label>
                                 <div class="col-sm-10">
                                      <textarea name="term_and_condition" rows='10' class="form-control"><?=set_value('term_and_condition')?><?=@$meta->term_and_condition?></textarea>

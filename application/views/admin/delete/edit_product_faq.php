            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('edit_product_faq/').$this->uri->segment('2').'/'.$this->uri->segment('3')?>"> 
                        <div class="form-group row">
                                <label class="col-sm-1 col-form-label">Title</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control form-control-square" name="title" value="<?=$product_faq->title?>" placeholder="Title">
                                    <?=form_error('title')?>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-1 col-form-label">Description</label>
                                 <div class="col-sm-5">
                                      <textarea name="description" rows='10' class="form-control"><?=set_value('description')?><?=@$product_faq->description?></textarea>

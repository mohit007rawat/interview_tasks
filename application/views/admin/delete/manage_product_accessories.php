...
include('include/header.php');
 $related_productId = explode(',',$accessories);
    ...
    <!--    </div>-->
        <div class="row">      
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-body">  
                        <form method="POST" action="<?=base_url('manage_product_accessories/').$this->uri->segment('2')?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Select Product's Accessories:</label>
                        <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    placeholder: "Select Product's Accessories",
    allowClear: true
});
});
</script>>
            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('edit_subcategory/').$this->uri->segment('2')?>" id="" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="cat_name" id="cat_name">
                                            ...
                                            <?php
                                                ...
                                                {
                                            ?>
                                                    <option value="<?=$v->id?>"  <?= $subcategory_details->category_id==$v->id?'selected':''?>><?=ucfirst($v->name)?></option>
                                            <?php       
                                                }
                                            ?>
                                        </select>                                 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control form-control-square" name="name" value="<?= $subcategory_details->name?>" placeholder="Category Name">
                                    <?=form_error('name')?>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <?php
                                    if(!empty($subcategory_details->image))
                                    {
                                ?>
                                <div class="col-sm-3">
                                    <img width="140px" height="120px" src="<?=base_url('assets/subcategory_img/').$subcategory_details->image?>">
                                </div>    
                                <?php
                                    }
                                ?>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control form-control-square" name="url" value="<?=$subcategory_details->url?>" placeholder="URL">
                                    <?=form_error('url')?>
                                </div>
                            </div>
                            <div class="form-group row">

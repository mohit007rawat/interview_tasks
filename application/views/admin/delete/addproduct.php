            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('admin/addProduct')?>" id="all_mall" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-square" name="name" value="<?=set_value('name')?>" placeholder="Enter item Name">
                                    <?=form_error('name')?>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-square" name="model_no" value="<?=set_value('model_no')?>" placeholder="Model Number">
                                    <?=form_error('model_no')?>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control form-control-square" name="sku_no" value="<?=set_value('sku_no')?>" placeholder="SKU Number">
                                    <?=form_error('sku_no')?>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control form-control-square" name="price" value="<?=set_value('price')?>" placeholder="Enter Product Price">
                                    <?=form_error('price')?>
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control form-control-square" name="dis_price" value="<?=set_value('dis_price')?>" placeholder="Enter Product Discount Price">
                            ...
                            <!-- <div class="form-group row">
                             ...
                             <!-- <div class="form-group row multi_color">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control form-control-square" placeholder="Color Name" name="product_color[]">
                        ...
                        ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control form-control-square" placeholder="Enter Product Quantity" name="qty">
                                    <?=form_error('qty')?>
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                     <select class="form-control form-control-square" name="filter_by_features" >
                                        ...
                                        <option value="bluetooth_wireless">Bluetooth- Wireless</option>
                                        <option value="truly_wireless">Truly Wireless</option>
                                    </select>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control form-control-square" name="short_desc"><?=set_value('short_desc')?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control form-control-square" name="item_description"><?=set_value('item_description')?></textarea>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" class="form-control form-control-square" name="warrenty_ext_price" value="<?=set_value('warrenty_ext_price')?>" placeholder="If Warrenty Extend Available*">

            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('edit_slider/').$this->uri->segment('2')?>" id="" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                ?>
                                <div class="col-sm-3">
                                    <img width="140px" height="120px" src="<?=base_url('assets/slider_img/').$slider->image?>">
                                </div>    
                                <?php
                                    }
                                ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control form-control-square" name="alt" value="<?=$slider->alt?>" placeholder="Alt Tag">
                                    <?=form_error('alt')?>
                                </div>
                            </div> 
                            <div class="form-group row">

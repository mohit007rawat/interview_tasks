    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Manage Privacy Policy</div>
                        <hr>
                        <form method="post" action="<?=base_url('admin/privacy_policy')?>"> 
                         ...
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Privacy Policy</label>
                                 <div class="col-sm-10">
                                      <textarea name="privacy_policy" rows='10' class="form-control"><?=set_value('privacy_policy')?><?=@$meta->privacy_policy?></textarea>
                                       <?=form_error('privacy_policy')?>
                                 </div>
                            </div>

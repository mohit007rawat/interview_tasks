    ...
    <div class="row pt-2 pb-2">
        ...
        <div class="row">      
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-body">  
                        <form method="POST" action="<?=base_url('update_product_thumb_image/').$this->uri->segment('2')?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-1 col-form-label">Update Thumb Image :</label>
                        <div class="col-sm-3">

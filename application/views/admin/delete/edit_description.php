    ...
    <div class="row pt-2 pb-2">
        ...
        <div class="row">      
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-body">  
                        <form method="POST" action="<?=base_url('admin/edit_description/').$this->uri->segment('2').'/'.$this->uri->segment('3')?>" enctype="multipart/form-data">
                   
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Add Thumb Image :</label>
                        <div class="col-sm-3">
                            <input type="file" accept="image/*" class="form-control form-control-square" name="img"><?=form_error('img')?>
                        </div>
                        <img width='180px' height='120px' src='<?=base_url('assets/description_img/').$description->img?>'>
                        </div>
                        <div class="form-group row"> 
                         <label class="col-sm-2 col-form-label">Alt Tag :</label>    
                         <div class="col-sm-3">
                            <input type="text" class="form-control form-control-square" value="<?=$description->alt?>" name="alt">
                            <?=form_error('alt')?>
                        </div>        
                    </div>    
                    <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Description</label>
                                 <div class="col-sm-10">
                                      <textarea name="product_description" rows='10' class="form-control"><?=set_value('product_description')?><?=@$description->product_info?></textarea>

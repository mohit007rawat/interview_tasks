    ...
    <div class="row pt-2 pb-2">
        ...
        <div class="row">      
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-body">  
                        <form method="POST" action="<?=base_url('update_product_gallery/').$this->uri->segment('2').'/'.$this->uri->segment('3')?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Update Gallery Image :</label>
                        <div class="col-sm-3">
                            <input type="file" accept="image/*" class="form-control form-control-square" name="thumb_image">
                        </div>  
                        <div class="col-sm-1">
                        ...
                        ?>      
                                <div class="col-md-3 mb-3">
                                   ...
                                   <img class="pro_img" src="<?=base_url('assets/product_image/').$v->image?>">
                                    ...
                                    href="<?=base_url('admin/remove_galary_image/').base64_encode($v->id)?>">Remove</a>
                                </div> 

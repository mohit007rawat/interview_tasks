                                ...
                                <tbody>
                                    ...
                                    <tr data-id="<?=$key->id?>">
                                       ...
                                       <td><?=ucfirst(json_decode($key->shipping_add)->name);?></td>
                                        ...
                                        <td>
                                            <a class="btn-sm btn-info" href="<?=base_url('admin/view_ongoing_orders/').base64_encode($key->id)?>">View Order Details</a>
                                         ...
                                         <td>
                                            <select class="form-control delivery_status">
                                                ...
                                                <option value="2" <?=($key->order_status == '2') ? 'selected' : ''?>>Completed</option>
                                            </select>

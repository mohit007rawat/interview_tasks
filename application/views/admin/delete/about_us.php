...
<div class="content-wrapper">
            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('admin/about_us')?>" enctype="multipart/form-data">
                         ...
                         <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-square" name="heading" value="<?=!empty($meta->heading) ? $meta->heading : set_value('heading')?>" placeholder="Heading">
                                    <?=form_error('heading')?>
                                </div>
                            </div> 
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">About us</label>
                                 <div class="col-sm-8">
                                      <textarea name="about_us" rows='10' class="form-control"><?=set_value('about_us')?><?=@$meta->about_us?></textarea>
                                       <?=form_error('about_us')?>
                                 </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">1st Our Team</label>
                                 <div class="col-sm-2">
                                       <input type="file" class="form-control form-control-square" name="img1" value="<?=!empty($meta->img1) ? $meta->img1 : set_value('img1')?>">
                                    <?=form_error('img1')?>
                                 </div>
                                 <div class="col-sm-8">
                                      <textarea name="first_desc" rows='10' class="form-control"><?=set_value('first_desc')?><?=@$meta->first_desc?></textarea>
                                       <?=form_error('first_desc')?>
                                 </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">2nd Our Team</label>
                                 <div class="col-sm-2">
                                       <input type="file" class="form-control form-control-square" name="img2" value="<?=!empty($meta->img2) ? $meta->img2 : set_value('img2')?>">
                                    <?=form_error('img2')?>
                                 </div>
                                 <div class="col-sm-8">
                                      <textarea name="second_desc" rows='10' class="form-control"><?=set_value('second_desc')?><?=@$meta->second_desc?></textarea>
                                       <?=form_error('second_desc')?>
                                 </div>
                            </div>                           
                             <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Description</label>
                                 <div class="col-sm-10">
                                      <textarea name="main_description" rows='10' class="form-control"><?=set_value('main_description')?><?=@$meta->main_description?></textarea>
                                       <?=form_error('main_description')?>
                                 </div>
                            </div>
                             <div class="form-group row">
    ...
    <script>
        $(document).ready(function(){
           ...
           CKEDITOR.replace( 'first_desc' );
           CKEDITOR.replace( 'second_desc' );

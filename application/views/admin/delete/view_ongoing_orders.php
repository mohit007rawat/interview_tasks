                                        ...
                                        <td><?=$v->qty?></td> 
                                           <td>
                                                    <select class="order_detail_status form-control" row_id="<?= base64_encode($v->id) ?>">
                                                        ...
                                                        <option value="1" <?php if($v->status == 1){ ?> selected="" <?php } ?>>Dispatched</option>
                                                        <option value="2" <?php if($v->status == 2){ ?> selected="" <?php } ?>>On the Way</option>
                                                        <option value="3" <?php if($v->status == 3){ ?> selected="" <?php } ?>>Order Complete</option>
                                                    </select>
                                                </td>                                      
...
<script type="text/javascript">
      $(document).ready(function() {
        let initialVal = $(".order_detail_status").find("option[selected]").attr('value');
        $(".order_detail_status").change(function() {
          ...
          else
          {
            ...
            $.ajax({
              url : "<?=base_url('admin/change_order_detail_status')?>",
              method : "POST",
              dataType : 'json',
              data : fd,
              processData: false,

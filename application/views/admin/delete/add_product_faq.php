            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('add_product_faq/').$this->uri->segment('2')?>"> 
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Description</label>
                                 <div class="col-sm-5">
                                      <textarea name="description" rows='10' class="form-control"><?=set_value('description')?><?=@$insert_into->description?></textarea>
